...
\begin{frame}{Single label classification}
	\begin{itemize}
		...
		\end{itemize}
		\item Many algorithms are available to tackle single label classification problems: support vector machines \citep{Cortes95support}, logistic regression \citep{Chen99}, etc.
	\end{itemize}
\end{frame}
