...
\begin{frame}{Example: dog vs. cat?}
	\begin{itemize}
		...
		\item \citet{Golle08machine} claimed this is a difficult task for machines with only $82.7\%$ accuracy (probability of getting a right answer).
...
\begin{frame}{Single label classification}
	\begin{itemize}
		...
		\begin{itemize}
			...
			(e.g., $\{\underbrace{(\vx_1,+1),\cdots,(\vx_{5000},+1)}_{\text{dog pictures}},\underbrace{(\vx_{5001},-1),\cdots, (\vx_{10000},-1)}_{\text{cat pictures}}\}$).
