...
\begin{frame}{Applications}
	\begin{itemize}
        ...
        \multirow{4}{*}{\includegraphics[scale = 0.15]{./figures/boatsea.png}} & \\
		...
		\begin{tabular}{p{3cm}p{10cm}}
        \multirow{4}{*}{\includegraphics[scale = 0.15]{./figures/titanic.jpg}} & \\
		& $(\underbrace{+1}_{\text{news}},\underbrace{-1}_{\text{land}},\underbrace{-1}_{\text{sport}},\underbrace{-1}_{\text{politics}},\underbrace{-1}_{\text{entertainment}},\underbrace{+1}_{\text{disaster}},\underbrace{+1}_{\text{rescue}})$\\
		&\\
		&\\
        \end{tabular}
		\item Molecular classification is to predict drug activities in different targets.\\
		\begin{tabular}{p{3cm}p{10cm}}
        \multirow{4}{*}{\includegraphics[scale = 0.15]{./figures/mol1.png}} & \\
		& $(\underbrace{+1}_{\text{news}},\underbrace{-1}_{\text{land}},\underbrace{-1}_{\text{sport}},\underbrace{-1}_{\text{politics}},\underbrace{-1}_{\text{entertainment}},\underbrace{+1}_{\text{disaster}},\underbrace{+1}_{\text{rescue}})$\\
		&\\
		&\\
        \end{tabular}
