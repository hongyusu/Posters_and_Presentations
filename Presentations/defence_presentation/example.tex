...
\begin{frame}{Applications}
	\begin{itemize}
		...
		& $(\underbrace{+1}_{\text{news}},\underbrace{-1}_{\text{land}},\underbrace{-1}_{\text{sport}},\underbrace{-1}_{\text{politics}},\underbrace{-1}_{\text{movie}},\underbrace{+1}_{\text{disaster}},\underbrace{+1}_{\text{rescue}})$\\
        \end{tabular}
		...
		\begin{tabular}{p{3cm}p{10cm}} 
        \multirow{2}{*}{\includegraphics[scale = 0.1]{./figures/facebookvideo.jpg}} & \\
...
\begin{frame}{How to solve multilabel classification?}
	...
	\begin{tabular}{p{3cm}p{10cm}}
    \multirow{2}{*}{\includegraphics[scale = 0.13]{./figures/boatsea.png}} & \\
	& $(\underbrace{?}_{\text{boat}},\underbrace{?}_{\text{sea}},\underbrace{?}_{\text{sun}},\underbrace{?}_{\text{beach}},\underbrace{?}_{\text{people}},\underbrace{?}_{\text{ice}},\underbrace{?}_{\text{land}})$\\
    \end{tabular}
	}
	\only<2>{
	\begin{tabular}{p{3cm}p{10cm}}
	...
	\begin{tabular}{p{3cm}p{10cm}}
    \multirow{2}{*}{\includegraphics[scale = 0.13]{./figures/boatsea.png}} & \\
	& $(\underbrace{+1}_{\text{boat}},\underbrace{}_{\text{sea}},\underbrace{}_{\text{sun}},\underbrace{}_{\text{beach}},\underbrace{}_{\text{people}},\underbrace{}_{\text{ice}},\underbrace{}_{\text{land}})$\\
    \end{tabular}
	}
	\only<4>{
	\begin{tabular}{p{3cm}p{10cm}}
	...
	\begin{tabular}{p{3cm}p{10cm}}
    \multirow{2}{*}{\includegraphics[scale = 0.13]{./figures/boatsea.png}} & \\
	& $(\underbrace{}_{\text{boat}},\underbrace{+1}_{\text{sea}},\underbrace{}_{\text{sun}},\underbrace{}_{\text{beach}},\underbrace{}_{\text{people}},\underbrace{}_{\text{ice}},\underbrace{}_{\text{land}})$\\
    \end{tabular}
	}
	\only<6>{
	\begin{tabular}{p{3cm}p{10cm}}
