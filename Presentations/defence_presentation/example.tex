...
\begin{frame}{Single label classification}
	\begin{itemize}
		...
		\begin{itemize}
			\footnotesize
			\item \textit{\color{aaltoblue} Input} is an object, e.g., an image, a document, a video, a sound clip.
			\item \textit{\color{aaltoblue} Output}: An attribute of the object, namely, \textit{\color{aaltoblue} label} .
		\end{itemize}
	\end{itemize}
\end{frame}
