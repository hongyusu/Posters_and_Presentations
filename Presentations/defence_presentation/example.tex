...
\begin{frame}{Why?}
	\begin{itemize}
		\item To test ASIRRA system is safe from machine learning attack.
		\begin{itemize}
			\footnotesize
			\item 
			\begin{center}
				\includegraphics[scale=0.3]{./figures/captcha.png}
				\text{     }
				\includegraphics[scale=0.3]{./figures/assira.jpg}
			\end{center}
		\end{itemize}
	\end{itemize}
\end{frame}
