...
\begin{frame}{Multilabel classification}
	\begin{itemize}
		...
		\begin{itemize}
			...
			(e.g., $\vy=(\underbrace{+1}_{\text{boat}},\underbrace{+1}_{\text{sea}},\underbrace{-1}_{\text{sun}},\underbrace{-1}_{\text{people}})$).
			\item Explore a set of known object and label pairs called \textit{training data} \\
			(e.g., $\{(\vx_1,+1),\cdots,(\vx_{5001},-1),\cdots\}$).
			\item Learn a \textit{mapping function} that predicts the label of a new object.\\		\end{itemize}
	\end{itemize}
\end{frame}
