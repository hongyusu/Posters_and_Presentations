...
\begin{frame}{Structured output prediction}
	\begin{itemize}
		...
		\end{itemize}
		\item \textit{Structured output prediction} 
		\begin{itemize}
			\footnotesize
			\item predict multiple attributes of an object at the same time.
			\item use an $output graph$ which describes the correlations.
		\end{itemize}
		\begin{itemize}
			\footnotesize
			\item
