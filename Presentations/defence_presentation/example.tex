...
\begin{frame}{Contribution of this dissertation}
	\begin{itemize}
		...
		\begin{itemize}
			\footnotesize
			\item Improve the performance on drug sensitivity prediction problem.
			\item Predict reliably the spread of a content in social network. 
		\end{itemize}
		\item For general multilabel classification problems without predefined output graph
		\begin{itemize}
			\item Several ensemble methods that combine a collection of structured output learners.
			\item A joint learning and inference framework
		\end{itemize}
	\end{itemize}
\end{frame}
