...
\begin{frame}{Can we do better than this?}
	\begin{itemize}
		...
		\begin{align*}
(\underbrace{+1}_{\text{Ted}},\underbrace{-1}_{\text{Alice}},\underbrace{+1}_{\text{David}},\underbrace{-1}_{\text{Mark}},\underbrace{-1}_{\text{Alex}},\underbrace{-1}_{\text{Zoe}},\underbrace{-1}_{\text{Frank}}, \cdots)
		\end{align*}
		\begin{center}
