...
\begin{frame}{Support vector machine}
	\only<1>{
	\begin{itemize}
		\item Represent objects into a feature space.
		\item For example, data points in 2-dimensional space.
		\item A feature space is a high dimensional space constructed by \textit{kernel functions}.
	\end{itemize}}
	\only<2>{
	\begin{itemize}
		\item Find a line to separate object of two classes.
	\end{itemize}}
	\only<3>{
	\begin{itemize}
