...
\begin{frame}{Applications}
	\begin{itemize}
        ...
        \multirow{3}{*}{\includegraphics[scale = 0.13]{./figures/boatsea.png}} & \\
		...
		\begin{tabular}{p{3cm}p{10cm}} 
        \multirow{3}{*}{\includegraphics[scale = 0.13]{./figures/titanic.jpg}} & \\
		...
		\begin{tabular}{p{3cm}p{10cm}} 
        \multirow{3}{*}{\includegraphics[scale = 0.4]{./figures/mol1.png}} & \\
