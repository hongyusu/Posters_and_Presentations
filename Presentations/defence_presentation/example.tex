...
\begin{frame}{How to solve multilabel classification?}
	...
	\begin{tabular}{p{2cm}p{10cm}} 
    \multirow{2}{*}{\includegraphics[scale = 0.08]{./figures/facebookvideo.png}} & \\
	& $\overset{f_1}{\rightarrow}(\underbrace{?}_{\text{Ted}},\underbrace{}_{\text{Alice}},\underbrace{}_{\text{David}},\underbrace{}_{\text{Mark}},\underbrace{}_{\text{Alex}},\underbrace{}_{\text{Zoe}},\underbrace{}_{\text{Frank}})$\\
    \end{tabular}
	}
	\only<3>{
	\begin{tabular}{p{2cm}p{10cm}} 
	...
	\begin{tabular}{p{2cm}p{10cm}} 
    \multirow{2}{*}{\includegraphics[scale = 0.08]{./figures/facebookvideo.png}} & \\
	& $\overset{f_2}{\rightarrow}(\underbrace{}_{\text{Ted}},\underbrace{?}_{\text{Alice}},\underbrace{}_{\text{David}},\underbrace{}_{\text{Mark}},\underbrace{}_{\text{Alex}},\underbrace{}_{\text{Zoe}},\underbrace{}_{\text{Frank}})$\\
    \end{tabular}
	}
	\only<5>{
	\begin{tabular}{p{2cm}p{10cm}} 
	...
	\begin{tabular}{p{2cm}p{10cm}} 
    \multirow{2}{*}{\includegraphics[scale = 0.08]{./figures/facebookvideo.png}} & \\
	& $\overset{f}{\rightarrow}(\underbrace{+1}_{\text{Ted}},\underbrace{-1}_{\text{Alice}},\underbrace{+1}_{\text{David}},\underbrace{-1}_{\text{Mark}},\underbrace{+1}_{\text{Alex}},\underbrace{-1}_{\text{Zoe}},\underbrace{-1}_{\text{Frank}})$\\
    \end{tabular}
	}
