...
\begin{frame}{Applications}
	\begin{itemize}
		...
		\begin{tabular}{p{3cm}p{10cm}} \footnotesize
        \multirow{4}{*}{\includegraphics[scale = 0.13]{./figures/boatsea.png}} & \\
		...
		\begin{tabular}{p{3cm}p{10cm}} \footnotesize
        \multirow{4}{*}{\includegraphics[scale = 0.13]{./figures/titanic.jpg}} & \\
		...
		\begin{tabular}{p{3cm}p{10cm}} \footnotesize
        \multirow{4}{*}{\includegraphics[scale = 0.4]{./figures/mol1.png}} & \\
