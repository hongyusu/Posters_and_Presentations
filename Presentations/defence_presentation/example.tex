...
\begin{frame}{Human verification system}
	\begin{itemize}
		...
		\end{center}
		\item If machine can assign correct attibute to all pictures, we can search pictures by attributes.
	\end{itemize}
\end{frame}
...
\begin{frame}{Search engine}
	\only<1>{
	\begin{itemize}
		\item Search all cat pictures.
	\end{itemize}
	\begin{center}
		\includegraphics[scale=0.075]{./figures/googledog.png}
	\end{center}
	}
	\only<2>{
	\begin{itemize}
		\item Search all dog pictures.
	\end{itemize}
	\begin{center}
		\includegraphics[scale=0.075]{./figures/googlecat.png}
	\end{center}
	}
\end{frame}
