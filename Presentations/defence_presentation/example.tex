...
\begin{frame}{Support vector machine}
	...
	\begin{itemize}
		...
		\item In practice, feature space is a high dimensional space achieved by \textit{feature maps}.
	\end{itemize}}
	\only<2>{
	\begin{itemize}
	...
	\end{itemize}}
	\begin{center}
		\only<1>{\includegraphics[scale=0.3]{./figures/svm0.pdf}}
		\only<2>{\includegraphics[scale=0.3]{./figures/svm.pdf}}
		\only<3>{\includegraphics[scale=0.3]{./figures/svm1.pdf}}
\end{center}
\end{frame}
