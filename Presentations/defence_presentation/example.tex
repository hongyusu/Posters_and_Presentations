...
\begin{frame}{Single label classification}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Learn a \textit{\color{aaltoblue}mapping function} that predict the label of an arbitrary object.
			\begin{align*}
				\text{an image} \underset{\rightarrow}{\text{mapping function}} \text{dog or cat?}
			\end{align*}
		\end{itemize}
		\item 
	\end{itemize}
