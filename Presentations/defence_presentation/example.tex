...
\begin{frame}{Multilabel classification}
	\begin{itemize}
		\item The problem is known as \textit{\color{aaltoblue}multilabel classification}.
		\item Multilabel classification is a natural extension to single label classification.
		\begin{itemize}
			\footnotesize
			\item Input is an object.
			\item Output is multiple attributes called \textit{\color{aaltoblue}multilabel}. 
		\end{itemize}
	\end{itemize}
\end{frame}
