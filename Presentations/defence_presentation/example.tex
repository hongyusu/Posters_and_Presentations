...
\begin{frame}{Model label correlations}
	\begin{itemize}
		\item Graph is a natural way to model correlations.
		\begin{itemize}
			\footnotesize
			\item Nodes correspond to multiple attributes.
			\item Edges correspond to correlations of a pair of attributes.
		\end{itemize}
		\item \textit{Structured output prediction} predict multiple attributes of an object by considering the $output graph$ describing the label correlations.
	\end{itemize}
\end{frame}
