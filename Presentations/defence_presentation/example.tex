...
\begin{frame}{Applications}
	\begin{itemize}
		...
		& $(\underbrace{+1}_{\text{Ted}},\underbrace{-1}_{\text{Alice}},\underbrace{-1}_{\text{David}},\underbrace{-1}_{\text{Mark}},\underbrace{-1}_{\text{stranger1}},\underbrace{+1}_{\text{stranger2}},\underbrace{+1}_{\text{stranger3}})$\\
        \end{tabular}
	\end{itemize}
\end{frame}
