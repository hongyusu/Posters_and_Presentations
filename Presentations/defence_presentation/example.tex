...
\begin{frame}{Single label classification}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Explore a set of known object and label pairs \\
			\textit{\color{aaltoblue} Training data} = \{(image\#1, dog), $\cdots$, (image\#m, cat)\}.
			\item Learn a \textit{\color{aaltoblue}mapping function} that predict the label of a unknown object, e.g., (new image, ?)
		\end{itemize}
	\end{itemize}
\end{frame}
