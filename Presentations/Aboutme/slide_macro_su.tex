...
\newcommand{\mmr}{{\sc mmr}}
\newcommand{\sop}{{\sc sop}}
% mkl
\newcommand{\kalign}{{\sc align}}
\newcommand{\kalignf}{{\sc alignf}}
\newcommand{\mkl}{{\sc mkl}}
\newcommand{\kunif}{{\sc unif}}
% transporter
\newcommand{\blast}{{\sc blast}}
\newcommand{\interproscan}{{\sc interproscan}}
\newcommand{\pssm}{{\sc pssm}}
\newcommand{\tcdb}{{\sc tcbb}}
\newcommand{\psiblast}{{\sc psiblast}}
\newcommand{\rpsblast}{{\sc rpsblast}}
\newcommand{\tc}{{\sc tc}}
%
