...
\begin{frame}
	\begin{center}
		\includegraphics[scale=0.09]{./figures/first.jpg}
	\end{center}
\end{frame}
...
\begin{frame}{About me}
	\begin{itemize}
		\item Postdoc in Helsinki Institute for Information Technology and Aalto University since 2015.5.
		\item Research: build advance machine learning models to solve large scale data analysis problem (research project).
		\item Equivalent to: learning, thinking, talking, implementing, reporting.
	\end{itemize}
	\begin{center}
		\includegraphics[scale = 0.04]{../Aboutme/plots/phd.jpg}
		\includegraphics[scale = 0.04]{../Aboutme/plots/office1.jpg}
		%\includegraphics[scale = 0.1]{../Aboutme/plots/office2.jpg}
	\end{center}
\end{frame}

\begin{frame}{Educations}
	\begin{center}
		\includegraphics[scale = 0.11]{../Aboutme/plots/photo1.jpg}
		\includegraphics[scale = 0.15]{../Aboutme/plots/photo2.png}
		\includegraphics[scale = 0.15]{../Aboutme/plots/photo3.png}
	\end{center}
	\begin{itemize}
	...
	\end{itemize}
	\begin{center}
		{\em 'Everything comes with a price. Some things just cost more than others.'} -Brom, {\em The Child thief}
	\end{center}
\end{frame}
...
\begin{frame}{Awards}
	\begin{itemize}
		...
		\begin{center}
			\includegraphics[scale=0.3]{../Aboutme/plots/awards1.png}
		\end{center}
	\end{itemize}
\end{frame}
...
\begin{frame}{A big fan of modern information technologies}
	\begin{itemize}
		\item \href{http://sentimentx.herokuapp.com}{http://sentimentx.herokuapp.com}
		\item \href{http://tripassistant.herokuapplcom}{http://tripassistant.herokuapp.com}
	...
	\end{itemize}	
	\begin{center}
		\includegraphics[scale=0.03]{../Aboutme/plots/keyboard.jpg}
	\end{center}
\end{frame}
...
\begin{frame}{A big fan of sports}
	\begin{itemize}
		...
		\begin{center}
			\includegraphics[scale=0.15]{../Aboutme/plots/basketball.jpg}
		\end{center}
...
\begin{frame}{A cat person}
	\begin{itemize}
		...
		\begin{center}
			...
			\includegraphics[scale=0.15]{../Aboutme/plots/pabulo3.jpg}
		\end{center}
		\item Miu
		\begin{center}
			\includegraphics[scale=0.15,origin=c]{../Aboutme/plots/miu.jpg}
		\end{center}
...
\begin{frame}{A hiker}
	...
	\begin{center}
		\includegraphics[scale=0.22,angle=-0,origin=c]{../Aboutme/plots/googlemap.png}
	\end{center}
\end{frame}
...
\begin{frame}{A photographer with a Flickr account}
	...
	\begin{center}
		\includegraphics[scale=0.25,angle=-0,origin=c]{../Aboutme/plots/flickr.jpg}
	\end{center}
\end{frame}
...
\begin{frame}{A bottle collector}
	...
	\begin{center}
		\includegraphics[scale=0.05,angle=-0,origin=c]{../Aboutme/plots/bottle1.jpg}
	\end{center}
\end{frame}
...
\begin{frame}[allowframebreaks]{{\red Motivated} by applications}
	\begin{itemize}\footnotesize
		...
		\newline
		\newline
$\vy_0=(\underbrace{+1}_{\blue\text{news}},\underbrace{+1}_{\blue\text{economics}},\underbrace{-1}_{\gray\text{sports}},\underbrace{-1}_{\gray\text{politics}},\underbrace{-1}_{\gray\text{movie}},\underbrace{-1}_{\gray\text{science}},\underbrace{-1}_{\gray\text{art}})$\\
		\end{center}
		\framebreak
		...
		\newline
		\newline
$\vy_0=(\underbrace{+1}_{\blue\text{boat}},\underbrace{+1}_{\blue\text{sea}},\underbrace{-1}_{\gray\text{sun}},\underbrace{-1}_{\gray\text{beach}},\underbrace{-1}_{\gray\text{people}},\underbrace{+1}_{\blue\text{ice}},\underbrace{+1}_{\blue\text{land}})$\\
		\end{center}
		\framebreak
		...
		\newline
		\newline
$\vy_0=(\underbrace{+1}_{\blue\text{heart}},\underbrace{+1}_{\blue\text{stroke}},\underbrace{+1}_{\blue\text{blood}},\underbrace{+1}_{\blue\text{fever}},\underbrace{-1}_{\gray\text{digest}},\underbrace{-1}_{\gray\text{liver}},\underbrace{+1}_{\blue\text{swelling}})$\\
		\end{center}
		\framebreak
		...
		\newline
		\newline
	$\vy_0=(\underbrace{+1}_{\blue\text{$\alpha-$channel}},\underbrace{+1}_{\blue\text{$\beta-$barrel}},\underbrace{+1}_{\blue\text{holins}},\underbrace{-1}_{\gray\text{vesicle fusion pores}},\underbrace{-1}_{\gray\text{Phosphotransfer-driven Group}})$\\
		\end{center}
		\framebreak
		...
		\newline
		\newline
$\vy_0=(\underbrace{+1}_{\blue\text{Ted}},\underbrace{-1}_{\gray\text{Alice}},\underbrace{+1}_{\blue\text{David}},\underbrace{-1}_{\gray\text{Mark}},\underbrace{+1}_{\blue\text{Alex}},\underbrace{-1}_{\gray\text{Zoe}},\underbrace{-1}_{\gray\text{Frank}})$\\
		\end{center}	
	\end{itemize}
\end{frame}
...
\begin{frame}{What is happening?}
	\begin{center}
		\only<1>{\includegraphics[scale=0.07]{./figures/dp.jpg}}
		\only<2>{\includegraphics[scale=0.07]{./figures/dp1.jpg}}
	\end{center}
\end{frame}
%
...
\begin{frame}{Pattern  and Exponential reduction}{Transporter protein classification \cite{su2015transporter}}
	\begin{itemize}\footnotesize
		...
		\only<6>{\includegraphics[scale=0.2]{./figures/tc5.pdf}}
		\only<7>{\includegraphics[scale=0.2]{./figures/tc6.pdf}}
		\end{center}
...
\begin{frame}{Actual model}
	\begin{itemize}
		...
		\begin{tabular}{|p{1cm}|p{0.3cm}p{0.3cm}p{0.8cm}|p{0.3cm}p{0.3cm}p{0.8cm}|} \hline
			\footnotesize
		    & \multicolumn{6}{c|}{$0/1$ (full annotation)} \\ \cline{2-7}
		    & \multicolumn{3}{c|}{$Linear$} & \multicolumn{3}{c|}{$Gaussian$} \\ \cline{2-7}
		    & \svm & \mmr & \sop & \svm & \mmr & \sop \\ \hline
...
\begin{frame}{Output graph is \daggraph}{Predicting network response \cite{su14structured}}
	...
	\only<2>{Alice tweets after World Cup final. \includegraphics[scale=0.5]{./figures/motivation_2.pdf}}
	\only<3>{Bob saw the tweet and retweets from Alice. \includegraphics[scale=0.5]{./figures/motivation_3.pdf}}
	\only<4>{Jacob retweets from Bob. \includegraphics[scale=0.5]{./figures/motivation_4.pdf}}
	\only<5>{Ben retweets from Jacob. \includegraphics[scale=0.5]{./figures/motivation_5.pdf}}
...
\begin{frame}{What is happening?}
	\begin{center}
		\only<1>{\includegraphics[scale=0.07]{./figures/networkresponseexample.jpg}}
		\only<2>{\includegraphics[scale=0.07]{./figures/maxcut.jpg}}
	\end{center}
\end{frame}
	...
	\end{itemize}
		\begin{tabular}{|c|c|p{5.5cm}|}
			...
			\footnotesize
			 ...
			 Tree & Polynomial & \dpg\ \cite{Rousu07}  \\
			 Graph & \nphard & \lbp\ \cite{su10structured}  \\ 
			 Pattern & Linear? & Reduction \cite{su2015transporter} \\ 
			 \daggraph & \nphard & \sdp\ \cite{su14structured} \\ \hline
...
\begin{frame}{Conclusions}
	\begin{itemize}\footnotesize
		...
		\begin{itemize}\footnotesize
			...
			\item Possible for exponential reduction of the search space.
		\end{itemize}
