...
\begin{frame}[allowframebreaks]{{\red Motivated} by applications}
	\begin{itemize}\footnotesize
		...
		\newline
		\newline
$\vy=(\underbrace{+1}_{\blue\text{news}},\underbrace{+1}_{\blue\text{economics}},\underbrace{-1}_{\gray\text{sports}},\underbrace{-1}_{\gray\text{politics}},\underbrace{-1}_{\gray\text{movie}},\underbrace{-1}_{\gray\text{science}},\underbrace{-1}_{\gray\text{art}})$\\
		\end{center}
		\framebreak
