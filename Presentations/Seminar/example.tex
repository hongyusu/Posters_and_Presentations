...
\begin{frame}{Contributions}
	\begin{itemize}\footnotesize
		...
		\begin{itemize}\footnotesize
			\item \mmcrf\ on general output graph structures \cite{su10structured}.
	...
	\begin{itemize}\footnotesize
		...
		\begin{tabular}{|c|c|c|}
			...
			\footnotesize
			 ...
			 Graph & \nphard & LBP \cite{su10structured}  \\ \hline
		\end{tabular}
		\item What if the output graph is a \daggraph\ ?
	\end{itemize}
\end{frame}

%
\begin{frame}{Output graph is directed}{Predicting network response \cite{su14structured}}
