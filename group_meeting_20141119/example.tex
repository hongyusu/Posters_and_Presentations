...
\begin{frame}{Fast Inference Over a Collection of Trees}
	\begin{itemize}
		\item $K$-best inference algorithm:
		\begin{itemize}
			\item Instead of computing the best multilabel $\vy_{T_t}$ from each individual spanning tree $T_t\in\Tcal$, we consider the $K$-best multilabel 
			\begin{align*}
